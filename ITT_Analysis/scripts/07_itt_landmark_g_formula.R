...
p <- ggplot(plot_df, aes(x = Year, y = mortality, color = group)) +
  ...
  labs(title = "Strategy 3: 12-Year Mortality Post-Treatment (Landmark T=0)",
       subtitle = "Estimated via G-formula starting at the day treatment ends",
       x = "Years from Treatment Outcome (Landmark T=0)",
