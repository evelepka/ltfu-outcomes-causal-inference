# 32f. Resistance subgroup target-trial under defn-B + grace
# Mirrors 32c but uses defn-B (LTFU exposure shifted back 30 days).
# Output: target_trial_defnB_resistance_mi.csv
...
cat(sprintf("[32f] %d imputed datasets; defn-B + grace\n", length(imp_files)))
